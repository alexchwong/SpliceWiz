...
knitr::include_graphics("img/buildRef.png")
```
...
knitr::include_graphics("img/Expr_empty.png")
```
...
knitr::include_graphics("img/Expr_drop_2.png")
```
...
knitr::include_graphics("img/Expr_pb.png")
```
...
knitr::include_graphics("img/Expr_cd.png")
```
...
knitr::include_graphics("img/Expr_load_empty.png")
```
...
```{r, echo=FALSE, out.width='640pt', fig.align = 'center', fig.cap="Loading the NxtSE GUI"}
knitr::include_graphics("img/Expr_load_folder.png")
```
...
knitr::include_graphics("img/Expr_anno_empty.png")
```
...
```{r, echo=FALSE, out.width='640pt', fig.align = 'center', fig.cap="NxtSE Annotations GUI"}
knitr::include_graphics("img/Expr_anno_filled.png")
```
...
knitr::include_graphics("img/Filters_empty.png")
```
...
knitr::include_graphics("img/Filters_applied.png")
```
</details>
\
...
knitr::include_graphics("img/DE_empty.png")
```
...
knitr::include_graphics("img/DE_limma.png")
```
...
knitr::include_graphics("img/Vis_volcano.png")
```
...
knitr::include_graphics("img/Vis_scatter.png")
```
...
knitr::include_graphics("img/Vis_volcano_select.png")
```
...
knitr::include_graphics("img/Vis_scatter_highlighted.png")
```
</details>
\
...
knitr::include_graphics("img/Vis_heatmap.png")
```
