...
<details>
<summary>What's New: Visualising junction reads in coverage plots (0.99.5+)</summary>
\
...
\
<details>
<summary>Plotting junction counts (new in 0.99.5+)</summary>
\
...
In SpliceWiz (>=0.99.5) junctions can be plotted by setting 
