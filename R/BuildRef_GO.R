...
#' @param ontologyRef A valid gene ontology reference, as generated by
#'   [viewGO].
...
goGenes <- function(
    ...
    .ora_internal(
        ontologyRef, enrichedGenes, universeGenes, 
        ontologyType, pAdjustMethod, ...
    )
}
...
.validate_GO_ref <- function(ont) {
    ...
    if(!all(c("go_id", "ontology", "go_term") %in% ont_cols)) {
