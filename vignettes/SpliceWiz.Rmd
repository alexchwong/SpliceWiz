...
The first function, storeRef(), requires 3 arguments:
...
`storeRef()` processes the given source genome / annotation files,
...
similar to `IRFinder()` but without the need to give the path to the SpliceWiz
reference:
