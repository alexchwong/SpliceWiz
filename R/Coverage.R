...
#'   in [makeSE]. Required by `plotCoverage`.
#' @param reference_path The path of the reference generated by
#'   [Build-Reference-methods]. Required by `plotGenome` if a \linkS4class{NxtSE}
...
#' COV files are generated by NxtIRF's [processBAM] and [BAM2COV] functions.
