...
compiled_with_htslib <- function() {
    .Call(`_SpliceWiz_compiled_with_htslib`)
}

SpliceWizMain_hts <- function(bam_file, reference_file, output_file, verbose, n_threads, read_pool) {
