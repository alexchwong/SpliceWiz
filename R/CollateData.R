...
#'
#'   Detection of novel ASEs:  When `detectNovelSplicing` is set to `TRUE`, 
...
#'   parameters can be set using `novelJn_minSamples`,
#'   `novelJn_countThreshold` and `novelJn_minSamplesAboveThreshold`
#'   respectively.
#'
...
#'   (see `novelJn_minSamples`, `novelJn_minSamplesAboveThreshold`, and
#'   `novelJn_countThreshold`) are used to synthesise a dataset-specific
#'   SpliceWiz reference. See details.
#' @param novelJn_minSamples (default 3) Novel junctions are included in
#'   building of novel reference  if number samples with non-zero counts
#'   exceeds this number.
#' @param novelJn_countThreshold (default 10) Threshold of split-reads across
#'   novel junctions; used in conjunction with 
#'   `novelJn_minSamplesAboveThreshold`
